...
//id, name, $single - true or false array
$prelaunch_price = get_post_meta( $postid,'prelaunch_price', true);
$launch_price = get_post_meta( $postid,'launch_price', true);
$final_price = get_post_meta( $postid,'final_price', true);
$course_url = get_post_meta( $postid,'course_url', true);
$button_text = get_post_meta( $postid,'button_text', true);
$optin_text = get_post_meta( $postid,'optin_text', true);
$optin_btn = get_post_meta( $postid,'optin_btn', true);
  ...
  <article>
    <div class="container clearfix">
      <div class="row">
        ...
        <div class="col-sm-5">
          <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/logo-badge.png" alt="Bootstrap to Wordpress" class="logo">
        </div><!-- col -->
...
<section id="project-features">
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-4">
        <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/icon-design.png" alt="Design">
        <h3>Sexy &amp; Modern Design</h3>
        <p>You get to work with a modern, professional quality design &amp; layout.</p>
      </div><!-- col -->
      <div class="col-sm-4">
        <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/icon-code.png" alt="Code">
        <h3>Quality HTML5 &amp; CSS3</h3>
        <p>You'll learn how hand-craft a stunning website with valid, semantic and beautiful HTML5 &amp; CSS3.</p>
      </div><!-- col -->
      <div class="col-sm-4">
        <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/icon-cms.png" alt="CMS">
    ...
    <div class="row">
      ...
      <div class="col-sm-8 col-sm-offset-2">
        ...
        <div class="row testimonial">
          <div class="col-sm-4">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/brennan.jpg" alt="Brennan">
          </div><!-- end col -->
          <div class="col-sm-8">
            <blockquote>
        ...
        <div class="row testimonial">
          <div class="col-sm-4">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/ben.png" alt="Illustration of a man with a moustache">
          </div><!-- end col -->
          <div class="col-sm-8">
            <blockquote>
        ...
        <div class="row testimonial">
          <div class="col-sm-4">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/aj.png" alt="Illustration of a man with a beard">
          </div><!-- end col -->
          <div class="col-sm-8">
            <blockquote>
        ...
        <div class="row testimonial">
          <div class="col-sm-4">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/ernest.png" alt="Illustration of a man with a goatee">
          </div><!-- end col -->
          <div class="col-sm-8">
            <blockquote>
